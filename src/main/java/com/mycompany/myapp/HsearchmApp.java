...
public class HsearchmApp {

    private static final Logger log = LoggerFactory.getLogger(HsearchmApp.class);
...
//        this.nodeSearchLuceneRepository.index();
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(HsearchmApp.class);
