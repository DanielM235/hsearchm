...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(com.mycompany.myapp.domain.Node.class.getName(), jcacheConfiguration);
            cm.createCache(com.mycompany.myapp.domain.NodeContent.class.getName(), jcacheConfiguration);
